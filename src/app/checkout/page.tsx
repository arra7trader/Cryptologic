...
export default function CheckoutPage() {
    ...
    const getTelegramLink = () => {
        const messages: Record<string, string> = {
            en: "Hi Admin, I have paid $14 USDT for Cryptologic Pro.\nTransaction Hash: [Paste your TxHash]\nEmail: [Your registered email]\n\nPlease activate my Pro account. Thank you!",
            id: "Halo Admin, saya sudah bayar $14 USDT untuk Cryptologic Pro.\nHash Transaksi: [Tempel TxHash Anda]\nEmail: [Email terdaftar Anda]\n\nMohon aktifkan akun Pro saya. Terima kasih!",
            cn: "您好管理员，我已支付 $14 USDT 购买 Cryptologic Pro。\n交易哈希：[粘贴您的 TxHash]\n电子邮件：[您注册的电子邮件]\n\n请激活我的 Pro 帐户。谢谢！"
        };
        const message = messages[language] || messages.en;
        return `https://t.me/cryptologicarra7?text=${encodeURIComponent(message)}`;
    };
