            ...
            >
                ...
                >
                    <div style={{ textAlign: "center", marginBottom: "32px" }}>
                        ...
                        <h1 style={{ fontSize: "24px", fontWeight: 700, color: colors.textPrimary }}>{t("admin.title")}</h1>
                        <p style={{ fontSize: "14px", color: colors.textDim, marginTop: "8px" }}>{t("admin.subtitle")}</p>
                    </div>
